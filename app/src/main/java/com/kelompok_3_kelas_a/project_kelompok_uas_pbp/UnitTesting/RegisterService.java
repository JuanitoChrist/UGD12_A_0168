...
public class RegisterService {
    ...
    public Boolean getValid(final RegisterView view, PenggunaModels penggunaModels, RegisterCallback callback,RegisterActivity activity, RequestQueue queue ) {
    ...
    RegisterCallback callback, RegisterActivity activity, RequestQueue queue) {
